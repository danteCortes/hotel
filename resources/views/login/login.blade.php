  ...
  <div class="form-signin" id="app">
    ...
    <div class="tab-content">
      <div id="login" class="tab-pane active">
        {{Form::open(['route'=>'ingresar', 'autocomplete'=>'off'])}}
          <p class="text-muted text-center">
            Ingrese su DNI y password
          </p>
          <input type="text" name="dni" placeholder="DNI" class="form-control top dni" required>
      ...
      <div id="signup" class="tab-pane">
        {{Form::open(['route'=>'primer-usuario', 'autocomplete'=>'off'])}}
          <input type="text" name="dni" placeholder="DNI" class="form-control top dni">
