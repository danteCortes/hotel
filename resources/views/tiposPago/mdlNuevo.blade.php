<div class="fade modal" id="mdlNuevoTipoPago">
  <div class="modal-dialog">
    <div class="modal-content">
      {{Form::open(['id'=>'frmNuevoTipoPago', 'autocomplete'=>'off', '@submit.prevent'=>'guardarTipoPago',
              ...
              <div class="form-group">
                ...
                <div class="col-sm-8">
                  {{Form::text('nombre', null, ['class'=>'form-control input-sm mayuscula', 'required'=>'',
                    'placeholder'=>'NOMBRE', 'v-model'=>'nuevoTipoPago.nombre'])}}
              ...
              <div class="form-group">
                ...
                <div class="col-sm-8">
                  {{Form::textarea('descripcion', null, ['class'=>'form-control input-sm mayuscula',
                    'placeholder'=>'DESCRIPCIÓN', 'v-model'=>'nuevoTipoPago.descripcion', 'rows'=>'3'])}}
        ...
        <div class="modal-footer" style="background-color:#385a94">
          ...
          {{Form::button('<span class="fa fa-save"> </span> Guardar', ['type'=>'submit', 
